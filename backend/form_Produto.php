...
<body>
  ...
  <form method="post" action="gravarProduto.php">
    ...
    <input type="double" name="tamanhoComprimentoPernaLateral"
      value="<?php echo $produto['tamanhoComprimentoPernaLateral'] ?>" /><br>
    Comprimento frente perna: <br>
    <input type="double" name="tamanhoComprimentoFrentePerna"
      value="<?php echo $produto['tamanhoComprimentoFrentePerna'] ?>" /><br>
